...
if options.scouting:
    ...
    "Cluster_ht700": {
        ...
        "yvar_regions": [0, 18, 50, 1000],
        "SR": [["SUEP_S1_CL", ">=", 0.5], ["SUEP_nconst_CL", ">=", 70]],
        "selections": [["ht", ">", 700], ["ntracks", ">", 0]],
    },
    "Cluster_L1scoutSingle_ht560": {
        "input_method": "CL",
        "method_var": "SUEP_S1_CL",
        "xvar": "SUEP_S1_CL",
        "xvar_regions": [0.3, 0.34, 0.5, 2.0],
        ...
        "yvar_regions": [0, 18, 50, 1000],
        "SR": [["SUEP_S1_CL", ">=", 0.5], ["SUEP_nconst_CL", ">=", 70]],
        "selections": [["ht", ">", 560], ["ntracks", ">", 0],["L1scoutSingle",">",0]],
    },
        "Cluster_L1scoutSingle_ht600": {
        "input_method": "CL",
        "method_var": "SUEP_S1_CL",
        "xvar": "SUEP_S1_CL",
        "xvar_regions": [0.3, 0.34, 0.5, 2.0],
        ...
        "yvar_regions": [0, 18, 50, 1000],
        "SR": [["SUEP_S1_CL", ">=", 0.5], ["SUEP_nconst_CL", ">=", 70]],
        "selections": [["ht", ">", 600], ["ntracks", ">", 0],["L1scoutSingle",">",0]],
    },
        "Cluster_L1scoutSingle_ht650": {
        "input_method": "CL",
        "method_var": "SUEP_S1_CL",
        "xvar": "SUEP_S1_CL",
        "xvar_regions": [0.3, 0.34, 0.5, 2.0],
        ...
        "yvar_regions": [0, 18, 50, 1000],
        "SR": [["SUEP_S1_CL", ">=", 0.5], ["SUEP_nconst_CL", ">=", 70]],
        "selections": [["ht", ">", 650], ["ntracks", ">", 0],["L1scoutSingle",">",0]],
    },
    "Cluster_L1scoutDouble_ht560": {
        "input_method": "CL",
        "method_var": "SUEP_S1_CL",
        "xvar": "SUEP_S1_CL",
        "xvar_regions": [0.3, 0.34, 0.5, 2.0],
        ...
        "yvar_regions": [0, 18, 50, 1000],
        "SR": [["SUEP_S1_CL", ">=", 0.5], ["SUEP_nconst_CL", ">=", 70]],
        "selections": [["ht", ">", 560], ["ntracks", ">", 0],["L1scoutDouble",">",0]],
    },
        "Cluster_L1scoutDouble_ht600": {
        "input_method": "CL",
        "method_var": "SUEP_S1_CL",
        "xvar": "SUEP_S1_CL",
        "xvar_regions": [0.3, 0.34, 0.5, 2.0],
        ...
        "yvar_regions": [0, 18, 50, 1000],
        "SR": [["SUEP_S1_CL", ">=", 0.5], ["SUEP_nconst_CL", ">=", 70]],
        "selections": [["ht", ">", 600], ["ntracks", ">", 0],["L1scoutDouble",">",0]],
    },
        "Cluster_L1scoutDouble_ht650": {
        "input_method": "CL",
        "method_var": "SUEP_S1_CL",
        "xvar": "SUEP_S1_CL",
        "xvar_regions": [0.3, 0.34, 0.5, 2.0],
        ...
        "yvar_regions": [0, 18, 50, 1000],
        "SR": [["SUEP_S1_CL", ">=", 0.5], ["SUEP_nconst_CL", ">=", 70]],
        "selections": [["ht", ">", 650], ["ntracks", ">", 0],["L1scoutDouble",">",0]],
    },    "Cluster_L1scoutSD_ht560": {
        "input_method": "CL",
        "method_var": "SUEP_S1_CL",
        "xvar": "SUEP_S1_CL",
        "xvar_regions": [0.3, 0.34, 0.5, 2.0],
        ...
        "yvar_regions": [0, 18, 50, 1000],
        "SR": [["SUEP_S1_CL", ">=", 0.5], ["SUEP_nconst_CL", ">=", 70]],
        "selections": [["ht", ">", 560], ["ntracks", ">", 0],["L1scoutSingle/L1scoutDouble", ">", 0]],
    },
        "Cluster_L1scoutSD_ht600": {
        "input_method": "CL",
        "method_var": "SUEP_S1_CL",
        "xvar": "SUEP_S1_CL",
        "xvar_regions": [0.3, 0.34, 0.5, 2.0],
        ...
        "yvar_regions": [0, 18, 50, 1000],
        "SR": [["SUEP_S1_CL", ">=", 0.5], ["SUEP_nconst_CL", ">=", 70]],
        "selections": [["ht", ">", 600], ["ntracks", ">", 0],["L1scoutSingle/L1scoutDouble", ">", 0]],
    },
        "Cluster_L1scoutSD_ht650": {
        "input_method": "CL",
        "method_var": "SUEP_S1_CL",
        "xvar": "SUEP_S1_CL",
        "xvar_regions": [0.3, 0.34, 0.5, 2.0],
        ...
        "yvar_regions": [0, 18, 50, 1000],
        "SR": [["SUEP_S1_CL", ">=", 0.5], ["SUEP_nconst_CL", ">=", 70]],
        "selections": [["ht", ">", 650], ["ntracks", ">", 0],["L1scoutSingle/L1scoutDouble", ">", 0]],
    },
    "ClusterInverted": {
        "input_method": "CL",
